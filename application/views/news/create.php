        ...
        <section class="content">
          <div class="box box-info">
            ...
            <div class="box-header">
              ...
              <label>Subject</label>
              <input type="input" name="title" id="title" class="form-control" placeholder="Enter Title or Subject">
            </div>
            <div class="box-body pad">

                <textarea name="text" id="text"  rows="10" cols="80" placeholder="Some News Here" required>

                </textarea>

            </div>
            <div class="box-footer">
              <center><button type="submit" value="Create news item" name="submit" class="btn btn-primary">Add News</button></center>
