        ...
        <section class="content">
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Stud Cops News Editor </h3>
              <!-- tools box -->
            ...
            <div class="box-header">
              <?php echo form_open('news/edit_news#myModal'); ?>
              <label>Subject</label>
              <!--<input type="input" name="title" id="title" class="form-control" placeholder="<?php //echo $news_item['title'];?>">-->
              <textarea name="title" id="title" class="form-control"><?php echo $news_item['title']; ?></textarea>
            </div>
            <div class="box-body pad">

                <textarea name="text1" id="text1"  rows="10" cols="80" placeholder="Some News Here" required>
            ...
            <!--<div class="form-group">
              <label>News ID</label>
              <input type="text2" class="form-control" placeholder="<?php //echo $news_item['id'];?>" disabled>
            </div>-->
            <div class="box-footer">
              <label>News ID</label>
              <textarea name="text2" id="text2" class="form-control" placeholder=""><?php echo $news_item['id'];?></textarea></br>
              <center><button type="submit" value="Create news item" name="submit" class="btn btn-primary">Edit News</button></center>
              <p align=center><?php if(isset($news_error))
              {echo $news_error;} ?>
            </p>
            </div>
            </form>
