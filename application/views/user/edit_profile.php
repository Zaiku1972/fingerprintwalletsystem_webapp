                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <div class="form-group">
                      <label for="profile_path">Upload Picture</label>
                      <input type="file" id="file" name="file"/>
                      <!--<p class="help-block">Select Path</p>-->
                    </div>
                  </div>
                  <p align=center>
                    <?php
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="submit" value="Upload Image" name="submit" class="btn btn-primary">Save changes</button>
                  </div>
                </form>
                </div><!-- /.modal-content -->
              </div><!-- /.modal-dialog -->
