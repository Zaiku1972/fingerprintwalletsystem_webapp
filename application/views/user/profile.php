          ...
          <!-- Profile Image -->
            <div class="login-box">
                ...
                <div class="box-body box-profile">
                  <img class="profile-user-img img-responsive img-circle" src="<?php echo $_SESSION['profile_link'];?>" alt="User profile picture">
                  <h3 class="profile-username text-center"><?php echo $name; ?></h3>
                  <!--<p class="text-muted text-center">Software Engineer</p>-->

                  <ul class="list-group list-group-unbordered">
                    <li class="list-group-item">
                      <b>Registered Mobile</b> <a class="pull-right"><?php echo $num; ?></a>
                    </li>
                    <li class="list-group-item">
                      <b>Email</b> <a class="pull-right"><?php echo $email; ?></a>
                    </li>
                    <li class="list-group-item">
                      <b>User Level</b> <a class="pull-right"><?php echo $u_level; ?></a>
                    </li>
                    <li class="list-group-item">
                      <b>Wallet Balance</b> <a class="pull-right"><?php echo $acc_bal; ?></a>
                    </li>
                  </ul>

                  <a href="<?php echo base_url().'users/edit_profile';?>" class="btn btn-primary btn-block"><b>Edit Profile</b></a>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div>
