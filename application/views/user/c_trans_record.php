              ...
              <div class="col-xs-12">
                <div class="box">
                  <div class="box-header">
                    <h3 class="box-title">Transaction Record:<b><?php echo $_SESSION['num']?></b></h3>
                  </div><!-- /.box-header -->
                  <div class="box-body">
                    <table id="trans_table" class="table table-bordered table-hover">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        <?php
                        if($trans_error == 1){
                          foreach($rec->result() as $value){
                            echo '<tr>';
                            echo '<td>'.$value->trans_id.'</td>';
                            echo '<td>'.$value->f_phone_no.'</td>';
                            echo '<td align=center>'.$value->amount.'</td>';
                            echo '<td>'.$value->ven_id.'</td>';
                            echo '<td>'.$value->date.'</td>';
                            echo '<td>'.$value->time.'</td>';
                            echo '<td>'.$value->acc_bal_rem.'</td>';
                            echo '</tr>';
                          }
                        }else{
