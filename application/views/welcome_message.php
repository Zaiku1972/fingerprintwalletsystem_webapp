        ...
        <section class="content">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <?php echo'<ul class="timeline">';?>
                <!-- timeline time label -->
              <?php echo'<li class="time-label">';?>
              <?php echo'<span class="bg-red">'.$news_item['date'].'</span>';?>
              ...
              <?php echo'</li>';?>
                ...
                <?php echo'<li>
                  ...
                  <div class="timeline-item">
                    <span class="time"><i class="fa fa-clock-o"></i>'.$news_item['time'].'</span>';?>
                    <?php echo'<h3 class="timeline-header">'.$news_item['title'].'<small> by '.$news_item['posted_by'].'</small></h3>';
                          //echo '<div class="timeline-body">'..'</div>';
                    ?>
                    <?php echo '<div class="timeline-footer">';?>
                      <?php echo'<a href="'; ?><?php echo site_url('news/'.$news_item['slug']);?><?php echo'"class="btn btn-primary btn-xs">View Article</a>';?>
                    <?php echo'</div>
                  </div>
                </li>';?>
                <?php endforeach; ?>
